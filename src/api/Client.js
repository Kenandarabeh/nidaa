...
class MoodlePage {
  ...
  async sendRequest(relativeUrl,courseId,params={}, wstoken, method = "POST" , context='courseids[0]') {
    let url = `${base_url}/webservice/rest/server.php?wstoken=${wstoken}&wsfunction=${relativeUrl}&moodlewsrestformat=json&${context}=${courseId}`;
...
export const moodlePageInstance = new MoodlePage();