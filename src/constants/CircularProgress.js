  ...
  render() {
    ...
    return (
      <View style={style}>
        ...
        <Defs>
        <LinearGradient id="grad" x1="0.5" y1="0" x2="0.5" y2="1" gradientTransform="matrix(1.000000, 0.000000, 0.000000, 1.000000, 0.000000, 0.000000)">
            <Stop offset="0" stopColor="#00a3e1" stopOpacity="1" />
            <Stop offset="1" stopColor="#001721" stopOpacity="0.8" />
          </LinearGradient>
        </Defs>
